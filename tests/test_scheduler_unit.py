...
def test_scheduler_init():
    ...
    print("  ✓ DownloadScheduler initializes correctly")
...
def test_scheduler_start_already_running():
    ...
    scheduler.stop()
    print("  ✓ start() is no-op when already running")
...
def test_update_from_config_disabled():
    ...
    print("  ✓ No jobs added when scheduler disabled")
...
def test_update_from_config_daily():
    ...
    print("  ✓ Daily job created from config")
...
def test_update_from_config_weekly():
    ...
    print(f"  ✓ Weekly job created with days: {job['days']}")
...
def test_update_from_config_invalid_time():
    ...
    print("  ✓ Invalid time falls back to 06:00")
...
def test_run_pending_disabled():
    ...
    print("  ✓ run_pending does nothing when disabled")
...
def test_run_pending_time_match_daily():
    ...
    print("  ✓ Daily job fires when time matches")
...
def test_run_pending_time_mismatch():
    ...
    print("  ✓ Job doesn't fire when time doesn't match")
...
def test_run_pending_weekly_day_match():
    ...
    scheduler.run_pending()
    callback.assert_called_once()
    print(f"  ✓ Weekly job fires on correct day ({current_day})")
...
def test_run_pending_weekly_day_mismatch():
    ...
    print(f"  ✓ Weekly job doesn't fire on wrong day (today: {today}, scheduled: {wrong_day})")
